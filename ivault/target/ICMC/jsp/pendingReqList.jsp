...
<body>
	...
	<div>
		<c:choose>
			...
			<form:form  method="post" action="assignVehicaltoReq" modelAttribute="vehcrewmapto">
				<c:forEach items="${pickup}" var="pickuplist">
				 ...
				 <input name = "imvcmVehicleNo" id = "imvcmVehicleNo" path="imvcmVehicleNo"/> </br> </br> </br>
				 <label>Custodian Id : </label>  
				 <input name = "imvcmCustId" id = "imvcmCustId" path="imvcmCustId"/> </br> </br> </br>
				 <label>Driver Id : </label>  
				 <input name = "imvcmDriverID" id = "imvcmDriverID" path="imvcmDriverID"/> </br> </br> </br>
				 <label>Crew Id : </label>  
				 <input name = "imvcmCrewId" id = "imvcmCrewId" path="imvcmCrewId"/> </br> </br> </br>
				   
				<p align="center">
					<button type="submit" name="Process" value="vehcrewmapto">PROCESS</button>
				</p>
				</form:form>
			</c:when>

			<c:otherwise>
				<h2>THERE IS NO ANY PENDING REQUEST...</h2> 
				<br />
				<br />
			</c:otherwise>
		</c:choose>
