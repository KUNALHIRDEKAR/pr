...
<body>
 ...
 %>
			...
			<div class="loginbox">
				<ul class="loginwrap">
					<form:form name='loginForm' action="loginProcess" method='POST'
						autocomplete="off">
						<!-- Set autocomplete="off"
						     autocomplete="autocomplete_off_hack_xfr4!k" 
						-->
						<li><label>NT ID:</label><span><input 
								type="text"
								autocomplete="autocomplete_off_hack_xfr4!k"
								autocorrect="off" 
								autocapitalize="off" 
					...
					.validate(
							{
								...
								submitHandler : function(form) {
									var isValid = $("form[name='loginForm']").validate().form();
									//alert(isValid);
									if (isValid) {
										//var passwd = btoa($('#password').val());
										//$('#password').val(passwd);
										//alert($('#password').val());
										form.submit();
									}
	...
	<table align="center">
		<tr>
			<td style="font-style: bold; color: red;">${message}</td>
		</tr>
	</table>
